import {
    GET_EXITSEVERANCE, GET_RESIGNATION_APPROVAL, UPDATE_ITNOC, GET_EMPLOYEE_DET,
    UPDATE_ADMINNOC, UPDATE_HRNOC, VIEW_SEVERANCE, UPDATE_FINANCENOC
...
export default function (state = intialState, action) {
    ...
    switch (type) {
        ...
        case UPDATE_FINANCENOC:
            return { ...state, Update_FinanceNoc: payload }
