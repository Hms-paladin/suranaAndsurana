import {
    GET_EMP_SUPERVISOR,INSERT_CHECKLIST_CREATION, GET_PROJ_SUBPROJ, GET_CHECKLIST_LISTS, GET_CHECKLIST_LISTS_NAMES, GET_CHECK_LIST_ASSIGNED, GET_CHECK_LIST_VIEW, GET_DAYS_WEEK
...
const initalState = {
    ...
    , getDaysofWeeks: [], getEmpSupervisor: []
}
