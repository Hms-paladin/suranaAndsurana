...
const initalState = {
  ...
  getClientlist: [],
  getStageList: [],
  getDesignationList: [], getDepartment: [], getInterviewersList: [], getInterviewStatus: [], getCourtLocation: [], GET_TRADE_MARK_STATUS: [], getActivity: [], getSubactivity: [],
};
