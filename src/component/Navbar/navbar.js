...
function Navbar(props) {
  ...
  const handleClicksub = (active) => {
    if (active === "severance") setSeveranceopen(!severanceopen);
    if (active === "master") setMasteropen(!masteropen);
    if (active === "usermanagement") setUserManageopen(!userManageopen);
    if (active === "onlinetest") setOnlineTestopen(!onlineTestopen);
  };

  const handlesubopen = (active) => {
    if (active === "severance") return severanceopen;
    if (active === "master") return masteropen;
    if (active === "usermanagement") return userManageopen;
    if (active === "onlinetest") return onlineTestopen;
  };
  ...
  useEffect(() => {
    if (props.UserPermission.length > 0 && props.UserPermission) {
      props.UserPermission.map((data) => {
        ...
        if (
          (data.control === "Resume - Go" && data.display_control === "Y") ||
          (data.control === "Resume - Create Resume" &&
            data.display_control === "Y") ||
          (data.control === "Resume - Interview Details" &&
            data.display_control === "Y") ||
          (data.control === "HR - Go" && data.display_control === "Y") ||
          (data.control === "Project - Go" && data.display_control === "Y") ||
          (data.control === "Project - Create Project" &&
            data.display_control === "Y") ||
          (data.control === "Project - Create Adhoc Task" &&
            data.display_control === "Y") ||
          (data.control === "Adhoc Task - Save" && data.display_control === "Y")
        ) {
          menuItems1.current[2].menu_rights = true;
        }

        if (
          (data.control === "Generate Invoice - Search" &&
            data.display_control === "Y") ||
          (data.control === "Generate Invoice - Generate" &&
            data.display_control === "Y")
        ) {
        ...
        if (
          data.control === "Check List Assigning" &&
          data.display_control === "Y"
        ) {
        ...
        if (
          (data.control === "Exit Interview Form - Save" &&
            data.display_control === "Y") ||
          (data.control === "Employee Feedback - Save" &&
            data.display_control === "Y")
        ) {
          if (
            data.control === "Exit Interview Form - Save" &&
        ...
        if (
          (data.control === "Leave Master - Save" &&
            data.display_control === "Y") ||
          (data.control === "User Masters - Save" &&
            data.display_control === "Y") ||
          (data.control === "CheckList Creation - Save" &&
            data.display_control === "Y") ||
          (data.control === "CheckList Creation - Add" &&
            data.display_control === "Y") ||
          (data.control === "Variable Rate Master - Save" &&
            data.display_control === "Y") ||
          (data.control === "Stage Template - Save" &&
            data.display_control === "Y")
        ) {
          if (
            data.control === "Variable Rate Master - Save" &&
        ...
        if (
          (data.control === "User Group - Add" &&
            data.display_control === "Y") ||
          (data.control === "UserMaster - Create User" &&
            data.display_control === "Y") ||
          (data.control === "Group Control - Add" &&
            data.display_control === "Y")
        ) {
          if (
            data.control === "User Group - Add" &&
        ...
        if (
          (data.control === "Add Questions - Add" &&
            data.display_control === "Y") ||
          (data.control === "Test - Submit" && data.display_control === "Y") ||
          (data.control === "Online Test - Submit" &&
            data.display_control === "Y")
        ) {
          if (
            data.control === "Add Questions - Add" &&
  ...
  const menuItems1 = useRef([
    ...
    {
      path: "/Home/generateinvoice",
      title: "Generate Invoice",
      img: Generateinvoice,
    },
    {
      path: "/Home/checklistAssigning",
      title: "Check List Assigning",
      img: Generateinvoice,
    },
    ...
    //severance
    {
      ...
      subtree: [
        ...
        {
          path: "/Home/employeeFeedback",
          title: "Employee Feedback Form",
          img: MasterIcon,
        },
        {
          path: "/Home/serverance_userview_Modal",
          title: "View Severance",
          img: MasterIcon,
        },
      ],
    },
    ...
    //master
    {
      ...
      subtree: [
        {
          path: "/Home/ratemaster",
          title: "Variable Rate Master",
          img: Variableratemaster,
        },
        {
          path: "/Home/stagesmaster",
  ...
  return (
    <div className={`navbarContainer ${classes.root}`}>
      <CssBaseline />
      <AppBar position="fixed" className={classes.appBar} open={drawer}>
        <Grid
          spacing={2}
          item
          xs={12}
        ...
        >
          ...
          >
            ...
            <span className="highlightedtitle">L</span>egal{" "}
            <span className="highlightedtitle">P</span>ractice{" "}
            <span className="highlightedtitle">M</span>anagement{" "}
            <span className="highlightedtitle">S</span>ystem
          </Grid>
          ...
          <Grid item xs={3} alignItems="center" className="userInfo">
            ...
            <div>
              ...
              <div className="userPosition">
                {JSON.parse(localStorage.getItem("token")).designation}
              </div>
            </div>
      ...
      <Drawer
        className={drawer ? classes.drawer : classes.miniDrawer}
        variant="permanent"
        classes={{
      ...
      >
        ...
        {drawer ? (
                ...
                if (!data.submenu) {
                  return (
                    <Link to={data.path} onClick={() => handleClick(data)}>
                      <div
                        className={`siderOptions ${data.path === pathname && "siderOptionsBg"
                          }`}
                      >
                        <div
                          className={`menuItemHighLightDark ${data.path === pathname && "menuItemHighLightDarkBg"
                            }`}
                        ></div>
                  ...
                  return (
                    <List
                      component="nav"
                      className={classes1.appMenu}
                      disablePadding
                    >
                      <ListItem
                        button
                        onClick={() => handleClicksub(data.active)}
                        className={classes1.menuItem}
                      >
                              ...
                              return (
                                ...
                                >
                                  <div
                                    id="submenu_div"
                                    className={
                                      subdata.path === pathname
                                        ? classes1.menuItemActive
                                        : classes1.menuItem
                                    }
                                  >
                                    {" "}
          ...
          <div className={classes.miniDrawerContainer}>
            {menuItems1.current.map((data, index) => {
              if (data.menu_rights) {
                if (!data.submenu) {
                  return (
                              ...
                              return (
                                ...
                                >
                                  <div
                                    ...
                                    className={
                                      subdata.path === pathname
                                        ? classes1.miniMenuItemActive
                                        : classes1.miniMenu
                                    }
                                  >
                                    <img
                                      src={subdata.img}
                                      className="miniSubMenuIcon"
                                    />
                                  </div>
                                </Link>
                              );
      ...
      <Box
        component="main"
        className={` MasterContainer ${classes.content}`}
        sx={{ flexGrow: 1, p: 3 }}
      >
        <Toolbar />
        <Route
          path={`${props.match.path}/DashboardNew`}
        ...
        />
        <Route
          path={`${props.match.path}/interview`}
          component={Interview}
          exact
        />
        <Route
          path={`${props.match.path}/employeeform`}
        ...
        />
        <Route
          path={`${props.match.path}/search/task/:task_id`}
        ...
        {/* Create Project Form */}
        <Route
          path={`${props.match.path}/projectFormCreate`}
          component={ProjectFormCreate}
          exact
        />
        {/* Ip TradeMark */}
        <Route
          path={`${props.match.path}/projectTask`}
          component={ProjectTask}
          exact
        />
        <Route
          path={`${props.match.path}/projectIp/:rowId`}
          component={ProjectIp1}
          exact
        />
        <Route
          path={`${props.match.path}/stageicon`}
          component={Stages}
          exact
        />
        <Route
          path={`${props.match.path}/stagesmaster`}
          component={StagesMaster}
          exact
        />
        <Route
          path={`${props.match.path}/addhearing`}
          component={AddHearing}
          exact
        />
        <Route
          path={`${props.match.path}/ratemaster`}
        ...
        {/* Litigation */}
        <Route
          path={`${props.match.path}/litigation`}
          component={Litigation}
          exact
        />
        {/* User Groups */}
        <Route
          path={`${props.match.path}/usergroups`}
          component={UserGroups}
          exact
        />
        {/*  Group Control */}
        <Route
          path={`${props.match.path}/groupcontrol`}
          component={GroupControl}
          exact
        />
        <Route
          path={`${props.match.path}/groupaccess`}
        ...
        {/*  Stage Monitering */}
        <Route
          path={`${props.match.path}/stagemonitering`}
        ...
        <Route
          path={`${props.match.path}/leaveform`}
          component={LeaveForm}
          exact
        />
        <Route
          path={`${props.match.path}/appraisal/:rowId`}
          component={Appraisal}
          exact
        />
        <Route
          path={`${props.match.path}/appraisal`}
          component={Appraisal}
          exact
        />
        <Route
          path={`${props.match.path}/ratingModel`}
          component={RatingModel}
          exact
        />
        <Route
          path={`${props.match.path}/ticketcreation`}
          component={TicketCreation}
          exact
        />
        <Route path={`${props.match.path}/KRA`} component={KRA} exact />
        <Route
          path={`${props.match.path}/adhoctask`}
          component={AdhocTask}
          exact
        />
        ...
        {/* Leaves Update */}
        <Route
          path={`${props.match.path}/leaveupdate`}
          component={LeaveUpdate}
          exact
        />
        <Route
          path={`${props.match.path}/severance`}
          component={Severance}
          exact
        />
        ...
        {/* EmployeeFeedback */}
        <Route
          path={`${props.match.path}/employeeFeedback`}
        ...
        <Route
          path={`${props.match.path}/employeelist`}
          component={EmployeeList}
        />
        <Route
          path={`${props.match.path}/librarybook`}
        ...
        <Route
          path={`${props.match.path}/newusermaster`}
          component={NewUserMaster}
        />
        <Route
          path={`${props.match.path}/useraccessrights`}
          component={userAccessRights}
        />
        {/* Library */}
        <Route
          path={`${props.match.path}/addresource`}
        ...
        {/* To do list */}
        <Route
          path={`${props.match.path}/appraisalView`}
          component={AppraisalView}
          exact
        />
        <Route
          path={`${props.match.path}/serverance_userview_Modal`}
          component={ServeranceModal}
          exact
        />
        <Route
          path={`${props.match.path}/MP_Appraisal`}
          component={MPAppraisal}
          exact
        />

        {/* DayReport */}
        <Route
          path={`${props.match.path}/dayreport`}
          component={DayReport}
          exact
        />
        ...
        {/* Online Test */}
        <Route
          path={`${props.match.path}/addquestion`}
          component={AddQuestion}
          exact
        />
        <Route
          path={`${props.match.path}/testtemplate`}
          component={TestTemplate}
          exact
        />
        <Route
          path={`${props.match.path}/onlinetest`}
          component={OnlineTest}
          exact
        />
        <Route
          path={`${props.match.path}/instructionModal`}
          component={InstructionModal}
          exact
        />
        <Route
          path={`${props.match.path}/onlineQA/:designation/:candidate/:testTemplateId`}
          component={OnlineQA}
          exact
        />
        ...
        {/* out of packet */}
        <Route
          path={`${props.match.path}/outofpacket`}
          component={OutofPacket}
          exact
        />
        {/* TimeSheet */}
        <Route
          path={`${props.match.path}/projectwise_timesheet`}
          component={ProjectwiseTS}
          exact
        />

        {/* checkListCreation */}
        <Route
          path={`${props.match.path}/checklistCreation`}
          component={checkListCreation}
          exact
        />
        <Route
          path={`${props.match.path}/checklistAssigning`}
          component={checkListAssign}
          exact
        />
        <Route
          path={`${props.match.path}/checklistview`}
        ...
        <Route
          path={`${props.match.path}/OpeExpense`}
          component={OPE_Expense}
          exact
        />
