    ...
    try {
        axios({
            ...
            data: {
                ...
                "file_cover": data.file_cover.value || "",
                "associate": data.associate.value || "",
                "our_reference": data.our_ref.value || "",
                "client_reference": data.client_ref.value || "",
                "application_no": data.app_num.value || "",
                "application_date": data.app_date.value ? moment(data.app_date.value).format("YYYY-MM-DD") : 0,
                "applicant": data.applicant.value || "",
                "title": data.title.value || "",
                "class_id": data.class.value || 0,
                "country_id": data.country.value || 0,
                "priority_country_id": data.priority_country.value || 0,
                "priority_date": data.priority_date.value ? moment(data.priority_date.value).format("YYYY-MM-DD") : 0,
                "status": data.status.value || 0,
                "comments": data.comments.value || "",
                "renewal_date": data.renewal_date.value ? moment(data.renewal_date.value).format("YYYY-MM-DD") : 0,
                "client_petitioner": "",
                "design_number": 0,
                "petitioner": "",
                "responent_rep": "",
