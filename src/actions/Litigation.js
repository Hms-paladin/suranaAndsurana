  ...
  try {
    axios({
      ...
      data:
      {
        ...
        court_case_no: Litigation_Form.courtcaseno.value || '',
        responsible_attorney: Litigation_Form.ddra.valueById || '0',
        next_hearing_date: Litigation_Form.hearingdate.value || "0000-00-00",
        due_date: Litigation_Form.duedate.value || "0000-00-00",
        sub_case: Litigation_Form.subcase.value || "0",
        suit_value: Litigation_Form.suitvalue.value || "",
