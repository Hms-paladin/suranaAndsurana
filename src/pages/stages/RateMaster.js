...
Axios({
    ...
    .then((response) => {
       ...
       projectSubActivitydata.push({value:data.sub_activity,id:data.sub_activity_id})
       )
...
Axios({
    ...
    .then((response) => {
       ...
       response.data.data.map((data)=>
       projectActivitydata.push({value:data.activity,id:data.activity_id})
       )
...
Axios({
    ...
    .then((response) => {
       ...
       response.data.data.map((data)=>
       projectDesignationData.push({value:data.designation,id:data.designation_id})
       )
  ...
  return(
      <div>
          ...
          <div className="rate_enhanced_table"><EnhancedTable headCells={header} 
          rows={varRateList.length ==0 ? varRateList : varRateList.rateList}/></div>  
      </div>
  )
}