...
function TimeSheetApproval(props) {
    ...
    const header = [
        ...
        { id: 'select_all', label: <div style={{ whiteSpace: 'nowrap' }}>Select All <Checkbox onClick={(e) => selectAll(e)} /></div> },
    ...
    return (
        <div className="time_s_t_root">
            ...
            <div className="time_s_btnsdiv">
                <CustomButton btnName={"Create TimeSheet"} btnCustomColor="customPrimary" custombtnCSS="timesheet_save" onBtnClick={() => setTimesheetOpens(true)} />
                <CustomButton btnName={"Approve"} btnCustomColor="customPrimary" custombtnCSS="timesheet_save" onBtnClick={() => ApproveTimesheet()} />
            </div>
