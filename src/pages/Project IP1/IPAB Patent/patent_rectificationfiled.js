...
import { getTradeMarkStatus,getClassDetails, insertPatentRectificationFiled} from "../../../actions/tradeMarkAction";
...
function onSubmit() {
    ...
    if (filtererr.length > 0) {
        ...
        dispatch(insertPatentRectificationFiled(params)).then(() => {
            handleCancel()
        })
    }
