        ...
        <div>
            ...
            <>
                <div className="linkingModel">
                    <div className="" onClick={() => appraisalModelOpen("Appraiser Comments")}>Appraiser Comments</div>
                </div>
                <div className="linkingModel">
                    <div className="" onClick={() => appraisalModelOpen("Instruction/Advice")}>Instruction/Advice</div>
                </div>
                <div className="linkingModel">
                    <div className="" onClick={() => appraisalModelOpen("Advice to Managing Partner")}>Advice to Managing Partner</div>
                </div>
            ...
            <>
                <div className="linkingModel">
                    <div className="" onClick={""}>Advice/Instruction to Appraise</div>
                </div>
                <div className="linkingModel">
                    <div className="" onClick={""}>Advice to HOD</div>
                </div>
                <div className="linkingModel">
                    <div className="" onClick={""}>Instruction to head Admin/HOD</div>
                </div>
                <div className="linkingModel">
                    <div className="" onClick={""}>Feedback of Managing Partner</div>
                </div>
            </>
            <>
