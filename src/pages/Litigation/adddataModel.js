...
import {
  InsertLitigationDetails,
  GetLitigation,
} from "../../actions/Litigation";
...
const AddDataModel = (props) => {
  ...
  useEffect(() => {
    ...
    props.getLitigationCounsel.map((dat) =>
      liti_councel.push({
        id: dat.liti_councel_id,
        value: dat.liti_councel,
      })
    );
        ...
        <div className="liticationDetails">
          ...
          {IteriumModel !== true ? (
            ...
            <>
              ...
              <Labelbox
                type="text"
                placeholder={"Interim Application No"}
                changeData={(data) =>
                  checkValidation(data, "interimapplicationno")
                }
              ...
              <Labelbox
                type="datepicker"
                placeholder={"Interim Application Date"}
                changeData={(data) =>
                  checkValidation(data, "interimapplicationdate")
                }
