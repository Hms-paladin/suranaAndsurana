...
function TodoList(props) {
    ...
    useEffect(() => {
        ...
        props.getHrTodoList.map((data) => {
            console.log(data,"___________________data_______________________________showid")
            let showId = null
            let showName = null
            let taskID = null
            ...
            hrList.push({ id: <div onClick={(id,name) => openModelFunc(showName,showId,taskID)} className="tempClass" >{showId}</div>, interviewDate: data.Interview_Date ? moment(data.Interview_Date).format('DD-MMM-YYYY') : null, designation: data.designation, candidates: data.no_of_candidates})
        })
    ...
    function openModelFunc(name,id,taskid) {
        ...
        if(name==="interviewer_id"){
            ...
            // let int_task_id = props.getHrTodoList.find((val)=>{
            //     return(
            //         taskid==val.task_id
            //     )
            // }) 
            // setTask_id(int_task_id)
            setviewer_id(int_viewer_id)
            console.log("___________________taskid",int_viewer_id)
            // console.log("________________",task_id)
        }
            ...
            setres_id(data_res_id) 
             console.log("___________________taskid",data_res_id)
        }
            ...
            console.log("___________________taskid",checkData)
        }
    }
